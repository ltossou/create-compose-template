...
internal class JsonTypeDetector {
    ...
    internal fun typeForJsonElement(jsonElement: JsonElement,
        ...
        with(jsonElement) {
            return when {
                ...
                isJsonNull -> Any::class.asTypeName().copy(nullable = true)
    ...
    private fun typeForJsonArray(jsonArray: JsonArray,
        ...
        // return ParameterizedTypeName.get(Array<Any>::class.asClassName().parameterizedBy(arrayType) , arrayType)
    ...
    private fun deduceArrayType(arrayTypes: HashSet<TypeName>, nullable: Boolean): TypeName {
        ...
        return when {
            nullable -> arrayTypeName.copy(nullable = true)
            else -> arrayTypeName
        }
    }
}